...
@Component({
  ...
  styleUrl: './popup-video.component.css'
})
export class PopupVideoComponent implements AfterViewInit, OnDestroy {
  videoUrl: any = '';
  videoId: string = '';
  ...
  ngAfterViewInit(): void {
    this.subscriptionURL = this.videoService.videoUrl$.subscribe(url => {
    ...
    this.subscriptionTime = this.videoService.currentTime$.subscribe(time => {
